...
public class DoxygenXmlParserTest_poco_Foundation_ans {
	...
	@Test
	public void poco_Foundationの作成_無名名前空間を表示するオプションoff() throws Throwable {
		try {
			xmlDir = new File(getClass().getClassLoader().getResource("poco_Foundation_ans/xml").getFile());
			...
			copy2Target(new File(tempFilepath), "poco_Foundation_ans.asta");
		} catch (Exception e) {
