...
public class DoxygenXmlParserTest_cppunit_1_12_0 {
	...
	@Test
	public void cppunit_1_12_0の作成() throws Throwable {
		try {
			xmlDir = new File(getClass().getClassLoader().getResource("cppunit_1_12_0/xml").getFile());
			...
			copy2Target(new File(tempFilepath), "cppunit_1_12_0.asta");
		} catch (Exception e) {
