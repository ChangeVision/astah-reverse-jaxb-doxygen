...
public class DoxygenXmlParserTest_asole {
	...
	@Test
	public void asoleの作成() throws Throwable {
		try {
			xmlDir = new File(getClass().getClassLoader().getResource("asole/xml").getFile());
			...
			copy2Target(new File(tempFilepath), "asole.asta");
		} catch (Exception e) {
