...
public class DoxygenXmlParserTest_input_encoding_error_in_compound_type {
	...
	public void input_encoding_error_in_compound_type() throws Throwable {
		xmlDir = new File(getClass().getClassLoader().getResource("input_encoding_error_in_compound_type/xml").getFile());
