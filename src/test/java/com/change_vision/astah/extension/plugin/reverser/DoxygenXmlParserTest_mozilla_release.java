...
public class DoxygenXmlParserTest_mozilla_release {
	...
	@Test
	public void mozilla_releaseの作成() throws Throwable {
		try {
			xmlDir = new File(getClass().getClassLoader().getResource("mozilla-release/xml").getFile());
			...
			copy2Target(new File(tempFilepath), "mozilla-release.asta");
		} catch (Exception e) {
