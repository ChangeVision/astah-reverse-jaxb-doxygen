...
public class DoxygenXmlParserTest_gtest_1_6_0 {
	...
	@Test
	public void gtest_1_6_0の作成() throws Throwable {
		try {
			xmlDir = new File(getClass().getClassLoader().getResource("gtest_1_6_0/xml").getFile());
			...
			copy2Target(new File(tempFilepath), "gtest_1_6_0.asta");
		} catch (Exception e) {
