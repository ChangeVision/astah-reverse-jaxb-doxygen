...
public class DoxygenXmlParserTest_sample_cpp {
	...
	@Test
	public void sample_cppの作成() throws Throwable {
		try {
			xmlDir = new File(getClass().getClassLoader().getResource("sample_cpp/xml").getFile());
			...
			copy2Target(new File(tempFilepath), "sample_cpp.asta");
		} catch (Exception e) {
