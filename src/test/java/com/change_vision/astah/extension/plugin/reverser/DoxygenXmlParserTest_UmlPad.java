...
public class DoxygenXmlParserTest_UmlPad {
	...
	@Test
	public void UmlPadの作成() throws Throwable {
		try {
			xmlDir = new File(getClass().getClassLoader().getResource("UmlPad/xml").getFile());
			...
			copy2Target(new File(tempFilepath), "UmlPad.asta");
		} catch (Exception e) {
